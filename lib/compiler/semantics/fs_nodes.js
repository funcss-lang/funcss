  ...
  FS.FunctionalStylesheet = (function() {
    function FunctionalStylesheet(ss, options1) {
      ...
      this._propertyTypes = {
        ...
        'height': vds("<length> | auto | <percentage>"),
        ...
        'transform': vds("none | rotate(<angle>) | scale(<number>) | translate(<length>, <length>)"),
        'top': vds("<length>"),
        'left': vds("<length>"),
        'position': vds("absolute | relative | static | fixed"),
        'overflow': vds("visible | hidden | auto")
      };
      this._typeStack = [
