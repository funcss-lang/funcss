...
(function() {
  ...
  VL.Color = (function(superClass) {
    ...
    Color.prototype.jsjs = function() {
      return "{r:" + (this.r.jsjs()) + ", g:" + (this.g.jsjs()) + ", b:" + (this.b.jsjs()) + ", a: " + (this.a.jsjs()) + "}";
    };

    Color.prototype.ssjs = function() {
      if (this.a) {
        return "'rgba('+" + (this.r.ssjs()) + "+','+" + (this.g.ssjs()) + "+','+" + (this.b.ssjs()) + "+','+" + (this.a.ssjs()) + "+')'";
      } else {
        return "'rgb('+" + (this.r.ssjs()) + "+','+" + (this.g.ssjs()) + "+','+" + (this.b.ssjs()) + "+')'";
      }
    };
