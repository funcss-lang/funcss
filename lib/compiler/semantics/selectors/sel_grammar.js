...
(function() {
  var ChildCombinator, ClassSelector, Colon, Combinable, Combinator, Combined, Dot, GR, PLACEHOLDER, Pseudoelementable, Pseudoelemented, SL, SS, Selector, SelectorGroup, SimpleSelector, Snd, TypeSelector;
  ...
  SimpleSelector = new GR.ExclusiveOr(TypeSelector, ClassSelector);
