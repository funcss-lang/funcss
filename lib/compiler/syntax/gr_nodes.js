...
(function() {
  var Cons, GR, Id, Opt, Or, Parser, SS, Snd, Swap, Tokenizer, assert, max,
  ...
  GR.Stream = (function() {
    function Stream(items, eof1, deltaPosition1) {
      var t;
      this.eof = eof1;
      this.deltaPosition = deltaPosition1 != null ? deltaPosition1 : 0;
      (this.items = (function() {
        var j, len, results;
        results = [];
    ...
    Stream.prototype.noMatchCurrent = function(expected) {
      throw new GR.NoMatch(expected, this.current, this, this.position - 1);
    };
  ...
  GR.NoMatch = (function(superClass) {
    ...
    NoMatch.prototype.createStack = function() {
      return this.stack = this.message + "\n" + (this.stackTrace());
    };

    NoMatch.prototype.merge = function(f) {
      if (this.stream.deltaPosition === f.stream.deltaPosition && this.position === f.position) {
        return new GR.NoMatch(this.expected + " or " + f.expected, this.found, this.stream, this.position);
      } else {
        throw (this.stream.deltaPosition + this.position > f.stream.deltaPosition + f.position ? this : f);
      }
    };
  ...
  GR.Grammar = (function() {
    function Grammar(semantic) {
      this.semantic = semantic != null ? semantic : this.semantic;
    }

    Grammar.prototype.parse = function(input, eof, deltaPosition) {
      var result, s;
      if (eof == null) {
        eof = "";
      }
    ...
    Grammar.prototype.setFs = function(fs) {
      var ref, ref1;
      this.fs = fs;
      if ((ref = this.a) != null) {
        ref.setFs(this.fs);
  ...
  GR.TokenTypeGrammar = (function(superClass) {
    extend(TokenTypeGrammar, superClass);

    function TokenTypeGrammar() {
      return TokenTypeGrammar.__super__.constructor.apply(this, arguments);
    }

    TokenTypeGrammar.prototype.props = {};

    TokenTypeGrammar.prototype.consume = function(s) {
      var k, next, ref, v;
      next = s.next();
      if (next == null) {
    ...
    TokenTypeGrammar.prototype.semantic = function(token) {};

    return TokenTypeGrammar;
  ...
  GR.Keyword = (function(superClass) {
    ...
    function Keyword(value1, semantic) {
      this.value = value1;
      this.semantic = semantic != null ? semantic : this.semantic;
  ...
  GR.Url = (function(superClass) {
    ...
    Url.prototype.expected = "url";

    Url.prototype.tokenClass = SS.UrlToken;

    Url.prototype.semantic = function(token) {
      return token.value;
    };
  ...
  GR.Hash = (function(superClass) {
    ...
    Hash.prototype.expected = "#";

    Hash.prototype.tokenClass = SS.HashToken;

    Hash.prototype.semantic = function(token) {
      return token.value;
    };
  ...
  GR.Dimension = (function(superClass) {
    extend(Dimension, superClass);

    function Dimension(metricName, semantic) {
      this.metricName = metricName;
      this.semantic = semantic != null ? semantic : this.semantic;
      this.expected = this.metricName;
    }

    Dimension.prototype.consume = function(s) {
      var next;
      this.stream = s;
      next = s.next();
      if (next == null) {
      ...
      if (!(next instanceof SS.DimensionToken || (next instanceof SS.NumberToken && next.value === 0))) {
        s.noMatchNext(this.expected);
      }
      return this.semantic(s.consume_next());
    };

    Dimension.prototype.semantic = function(dimension_or_zero_token) {};
  ...
  GR.DelimLike = (function(superClass) {
    ...
    DelimLike.prototype.toString = function() {
  ...
  GR.Comma = (function(superClass) {
    ...
    Comma.prototype.toString = function() {
      return ",";
    };
  ...
  GR.Optional = (function(superClass) {
    ...
    Optional.prototype.parse = function(input, eof, deltaPosition) {
      var result, s;
      if (eof == null) {
        eof = "";
      }
  ...
  GR.Juxtaposition = (function(superClass) {
    ...
    Juxtaposition.prototype.toString = function() {
  ...
  GR.CloselyJuxtaposed = (function(superClass) {
    ...
    CloselyJuxtaposed.prototype.toString = function() {
      return "[" + this.a + "]~[" + this.b + "]";
    };
  ...
  GR.ExclusiveOr = (function(superClass) {
    ...
    ExclusiveOr.prototype.toString = function() {
      return "[" + this.a + "]|[" + this.b + "]";
    };
  ...
  GR.InclusiveOr = (function(superClass) {
    ...
    InclusiveOr.prototype.toString = function() {
      return "[" + this.a + "]||[" + this.b + "]";
    };
  ...
  GR.ZeroOrMore = (function(superClass) {
    ...
    ZeroOrMore.prototype.toString = function() {
      return "[" + this.a + "]*";
    };
  ...
  GR.DelimitedBy = (function(superClass) {
    ...
    DelimitedBy.prototype.toString = function() {
      return "[" + this.a + "] [[" + this.delim + "] [" + this.a + "]]*";
    };
  ...
  GR.DelimitedByComma = (function(superClass) {
    ...
    DelimitedByComma.prototype.toString = function() {
      return "[" + this.a + "]#";
    };
  ...
  GR.AnnotationRoot = (function(superClass) {
    ...
    function AnnotationRoot(a1, semantic) {
      ...
      this.semantic = semantic != null ? semantic : this.semantic;
      this.markings = [];
      this.prepareMarkings(this.a);
    }

    AnnotationRoot.prototype.prepareMarkings = function(node) {
      if (node instanceof GR.AnnotationRoot) {
        if (node instanceof GR.Annotation) {
          this.hasAnnotations = true;
          node.root = this;
        }
        return node.prepareMarkings(node.a);
      } else {
        if (node.a) {
          this.prepareMarkings(node.a);
        }
        if (node.b) {
          return this.prepareMarkings(node.b);
        }
      }
    };

    AnnotationRoot.prototype.toString = function() {
      return "" + this.a;
    };
    ...
    AnnotationRoot.prototype.parseWithAnnotations = function(s) {
      ...
      try {
        ...
        return this.semantic(result, this.markings[this.markings.length - 1]);
      } finally {
        this.markings.pop();
      }
    };

    AnnotationRoot.prototype.setMarking = function(name, value) {
      return this.markings[this.markings.length - 1][name] = value;
    };
  ...
  GR.Annotation = (function(superClass) {
    ...
    Annotation.prototype.consume = function(s) {
      if (this.root) {
        return this.root.setMarking(this.name, this.hasAnnotations ? this.parseWithAnnotations(s) : this.semantic(this.a.consume(s)));
      } else {
  ...
  GR.SimpleBlock = (function(superClass) {
    ...
    SimpleBlock.prototype.consume = function(s) {
      ...
      s.consume_next();
      return this.semantic(this.a.parse(next.value, "" + (new ((new this.tokenClass).mirror())), s.deltaPosition + s.position));
    };

    SimpleBlock.prototype.toString = function() {
      return (new this.tokenClass) + " " + this.a + " " + (new ((new this.tokenClass).mirror()));
    };
  ...
  GR.TypeReference = (function(superClass) {
    ...
    TypeReference.prototype.consume = function(s) {
      ...
      try {
        ...
        e = _error;
        if (e instanceof GR.NoMatch && e.stream === s && e.position === pos) {
          throw new GR.NoMatch(this.expected, e.found, s, pos);
        } else {
          throw e;
        }
      }
    ...
    TypeReference.prototype.toString = function() {
      return "<" + (this.quoted ? JSON.stringify(this.name) : this.name) + ">";
    };
  ...
  GR.FunctionalNotation = (function(superClass) {
    ...
    FunctionalNotation.prototype.consume = function(s) {
      ...
      s.consume_next();
      return this.semantic(this.a.parse(next.value, ")", s.deltaPosition + s.position));
    };
  ...
  GR.AnyFunctionalNotation = (function(superClass) {
    ...
    AnyFunctionalNotation.prototype.consume = function(s) {
      ...
      s.consume_next();
      return this.semantic(next.name, this.a.parse(next.value, ")", s.deltaPosition + s.position));
    };

    AnyFunctionalNotation.prototype.toString = function() {
      return "<-funcss-any-functional-notation>";
    };
  ...
  GR.RawTokens = (function(superClass) {
    ...
    RawTokens.prototype.toString = function() {
      return "<-funcss-raw-tokens>";
    };
